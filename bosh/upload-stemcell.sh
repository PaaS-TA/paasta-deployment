...
if [[ ${IaaS} = "aws" ]]; then
        ...
        bosh -e ${BOSH_Director_Name} upload-stemcell upload-stemcell https://s3.amazonaws.com/bosh-core-stemcells/${STEMCELL_VERSION}/bosh-stemcell-${STEMCELL_VERSION}-vsphere-esxi-ubuntu-xenial-go_agent.tgz -n
else
