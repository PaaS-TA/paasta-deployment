...
SSH                  TCP      22          <((private_cidr))>        BOSH SSH (optional)
Custom TCP Rule      TCP      4222        <((private_cidr))>        NATS
Custom TCP Rule      TCP      25250       <((private_cidr))>        Blobstore
Custom TCP Rule      TCP      25777       <((private_cidr))>        Registry if enabled
```
